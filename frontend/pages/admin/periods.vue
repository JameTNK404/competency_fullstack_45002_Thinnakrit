  ...
  <div class="container mx-auto px-4 py-6">
    <div class="flex items-center justify-between mb-4 gap-3">
      ...
      <div class="flex items-center gap-3 w-full sm:w-80">
        <v-text-field v-model="search" label="ค้นหารอบการประเมิน" variant="outlined" density="compact" prepend-inner-icon="mdi-magnify" hide-details class="bg-white rounded" />
      </div>
    </div>
